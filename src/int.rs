...
mod test {
    ...
    fn to_string_10() {
        let cases = [
            ...
            ("123",      Int::from(123)),
            ("-456",     Int::from(-456)),
         //   ("1000000000000000000000001", Int::from_str("1000000000000000000000001").unwrap()),
            ("987654321012345678900111213987654321012345678910111213987654321012345678910111213",
             Int::from_str("987654321012345678900111213987654321012345678910111213987654321012345678910111213").unwrap()),
        ];
