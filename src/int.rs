...
mod test {
    ...
    fn to_string_10() {
        let cases = [
            ...
            ("123",      Int::from(123)),
            ("-456",     Int::from(-456)),
            ("1111111111111111111111111111111111111111", Int::from_str("1111111111111111111111111111111111111111").unwrap()),
            ("98765432101234567890111213987654321012345678910111213987654321012345678910111213",
             Int::from_str("98765432101234567890111213987654321012345678910111213987654321012345678910111213").unwrap()),
        ];
