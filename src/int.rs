...
impl Int {
    ...
    pub fn from_str_radix(mut src: &str, base: u8) -> Result<Int, ParseIntError> {
        ...
        if i.size > 1 {
            ...
            println!("OUT_16: {:?}", i.to_str_radix(16, false));
            println!("OUT_8: {:?}", i.to_str_radix(8, false));
...
mod test {
    ...
    fn to_string_10() {
        let cases = [
            ...
            ("123",      Int::from(123)),
            ("-456",     Int::from(-456)),
            ("0",     Int::from_str("0").unwrap()),
            ("1",     Int::from_str("1").unwrap()),
            ("65533",     Int::from_str("65533").unwrap()),
            ("65534",     Int::from_str("65534").unwrap()),
            ("65535",     Int::from_str("65535").unwrap()),
            ("65536",     Int::from_str("65536").unwrap()),
            ("4294967293", Int::from_str("4294967293").unwrap()),
            ("4294967294", Int::from_str("4294967294").unwrap()),
            ("4294967295", Int::from_str("4294967295").unwrap()),
            ("4294967296", Int::from_str("4294967296").unwrap()),
            ("281474976710654", Int::from_str("281474976710654").unwrap()),
            ("281474976710655", Int::from_str("281474976710655").unwrap()),
            ("281474976710656", Int::from_str("281474976710656").unwrap()),
            ("281474976710657", Int::from_str("281474976710657").unwrap()),
            ("18446744073709551614", Int::from_str("18446744073709551614").unwrap()),
            ("18446744073709551615", Int::from_str("18446744073709551615").unwrap()),
            ("18446744073709551616", Int::from_str("18446744073709551616").unwrap()),
            ("18446744073709551617", Int::from_str("18446744073709551617").unwrap()),
            ("1340780792994259709957402499820584612747936582059239337772356144372176403007354697680187429816690342769003185818648605085375388281194656994643364900608409", Int::from_str("1340780792994259709957402499820584612747936582059239337772356144372176403007354697680187429816690342769003185818648605085375388281194656994643364900608409").unwrap()),
            ("13407807929942597099574024998205846127479365820592393377723561443721764030073546976801874298166903427690031858186486050853753882811946569946433649006084096", Int::from_str("13407807929942597099574024998205846127479365820592393377723561443721764030073546976801874298166903427690031858186486050853753882811946569946433649006084096").unwrap()),
        ];
